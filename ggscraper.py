...
class GoogleGroupsScraper(object):
    ...
    def _get_driver(self):
        ...
        driver = webdriver.Chrome(executable_path="/PathToYourGeckoORChromeDriver/")
    ...
    def _get_last_post(self):
        ...
        last_post = self.driver.find_elements_by_css_selector('.F0XO1GC-p-Q')[-1]
        #last_post = post_list[-1]
        #last_post = self.driver.find_elements_by_class_name('F0XO1GC-rb-t')[-1]
    ...
    def _get_post_list(self):
        ...
        #return self.driver.find_elements_by_css_selector('.F0XO1GC-p-Q')
        return self.driver.find_elements_by_css_selector('.F0XO1GC-p-Q')
    ...
    def _get_raw_url(self, thread_url, message_id):
        ...
        #url_fmt = 'https://groups.google.com/d/msg/%s/%s/%s'
    ...
    def _get_urls_from_post_list(self, post_list):
        ...
        urls = [
            el.get_attribute('href') for el in post_list
...
if __name__ == "__main__":
    forum_url = 'https://groups.google.com/forum/#!forum/xx' # url of the google group (private or public) you are scraping
